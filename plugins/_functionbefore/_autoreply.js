...
export async function before(m) {
	...
	if (m.text.toLowerCase() == 'kin' || m.text.toLowerCase() == 'kinda' ) await this.reply(m.chat, kin.getRandom())
	return !0
}

const kin = ['apa sih','apa sayang','jangan ngagetin dong','iya','kenapa dah','bodo amat', 'kangen ?']
